...
export default function CompanyIncorporationPage() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (!data.hasDraft && !onboardingIdParam && !redirecting) {
            console.log(
              "❌ No draft found, redirecting to client registration"
            );
            setRedirecting(true);
  ...
  // 🔵 NEW: Panama redirect logic (multi-page flow)
  useEffect(() => {
    ...
    // → redirect to /company-incorporation/panama/legal-entity
